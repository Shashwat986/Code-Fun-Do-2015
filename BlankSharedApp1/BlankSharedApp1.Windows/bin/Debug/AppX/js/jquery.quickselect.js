    ...
    return this.each(function(){
      ...
      if(input.tagName == 'INPUT'){
        ...
        MSApp.execUnsafeLocalFunction(function () {
            text_input = $("<input type='text' class='"+className+"' id='"+id+"_quickselect' accesskey='"+accesskey+"' tabindex='"+tabindex+"' />");
            if(selected_option){text_input.val($(selected_option).text());}
            hidden_input = $("<input type='hidden' id='"+id+"' name='"+input.name+"' />");
